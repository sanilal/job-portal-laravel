                        ...
                        <ul class="navbar-nav align-items-center py-2 py-lg-0">
                            ...
                            <li class="nav-item"> 
                                <a class="nav-link" href="javascript:void(0)">
                                    <img class="me-2 country-flag" style="width: 20px; border-radius:50%"
                                                src="assets/img/uae.svg"/>
                                ...
                                <ul class="nav submenu language-menu">
                                    @foreach(getUserLanguages() as $key => $value)
                                        <li class="languageSelection {{ (checkLanguageSession() == $key) ? 'active' : '' }}"
                                            ...
                                            <a class="dropdown-item {{$value == 'English' ? 'english' : 'arabic'}} {{ (checkLanguageSession() == $key) ? 'active' : '' }}"
