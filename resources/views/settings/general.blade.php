...
@section('section')
    ...
    <div class="row">
        ...
        {{--                         src="{{($setting['logo']) ? asset($setting['logo']) : asset('assets/img/site-logo.png')}}">--}}
        {{--                </div>--}}
        {{--            </div>--}}
        {{--        </div>--}}
                    ...
                    <div class="d-block">
                        <div class="image-picker">
                            <div class="image previewImage" id="logoPreview"
                                 style="background-image: url({{ !empty($setting['logo']) ? $setting['logo'] : asset('assets/img/site-logo.png') }})">
                            </div>
                    ...
                    <div class="d-block">
                        <div class="image-picker">
                            <div class="image previewImage" id="footerLogoPreview"
                                 style="background-image: url({{ !empty($setting['footer_logo']) ? $setting['footer_logo'] : asset('assets/img/site-logo.png') }})">
                            </div>
                            <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                                  data-placement="top" data-bs-original-title="{{__('messages.tooltip.change_app_logo')}}">
                    <label>
                    ...
                    <div class="d-block">
                        <div class="image-picker">
                            <div class="image previewImage" id="faviconPreview"
                                 style="background-image: url({{ !empty($setting['favicon']) ? $setting['favicon'] : asset('assets/img/site-logo.png') }})">
                            </div>
                            <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
        ...
        {{--                         src="{{($setting['footer_logo']) ? asset($setting['footer_logo']) : asset('assets/img/site-logo.png')}}">--}}
        {{--                </div>--}}
        {{--            </div>--}}
        {{--        </div>--}}
        {{--        <div class="form-group col-sm-4">--}}
        ...
        {{--                         src="{{($setting['favicon']) ? asset($setting['favicon']) : asset('assets/img/site-logo.png')}}">--}}
        {{--                </div>--}}
        {{--            </div>--}}
        {{--        </div>--}}
