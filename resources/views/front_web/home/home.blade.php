...
@section('content')
                                        ...
                                        <div class="find-job position-relative bg-white px-20">
                                            <form action="{{ route('front.search.jobs') }}" id='searchForm' method="get">
                                                <div class="row align-items-center justify-content-around px-3">
                                                    <div class="col-lg-9 br-2 mb-lg-0 mb-3 pb-3 ps-lg-4 d-flex input-text ">
    ...
    {{-- How it Works starts --}}
    <section class="section-steps-alpha mt-5 mb-5 pt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="section-heading-style-alpha">
                        ...
                        <div class="section-intro-text text-center">
                            <p>Follow the three simple steps to get started.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="section-steps-alpha-item h-100">
                        <a href="http://arkanjobs.webhostingdubai.net/login">
                        ...
                        <div class="row align-items-center h-100">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="section-steps-alpha-item-content">
                                    <p>Simply login with an existing gmail or linkedin account or create a new onsite account to get started</p>
                                </div>
                    ...
                    <div class="section-steps-alpha-item h-100">
                        ...
                        <div class="row align-items-center h-100">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="section-steps-alpha-item-heading">
                                    <h2>Complete Resume</h2>
                                </div>
                                <div class="section-steps-alpha-item-content">
                                    <p>Create a detailed resume with your job experiences, academic qualifications, skills and more</p>
                                </div>
                                <div class="section-steps-alpha-item-number">
                                    <p>2</p>
                                </div>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="section-steps-alpha-item h-100">
                        <a href="http://arkanjobs.webhostingdubai.net/jobs">
                        <div class="section-steps-alpha-item-background-border"></div>
                        <div class="row align-items-center h-100">
                            <div class="col-md-12 col-sm-12">
                                <div class="section-steps-alpha-item-icon">
                                ...
                                <div class="section-steps-alpha-item-content">
                                    <p>Find job that best matches your area of expertise and qualifications.</p>
                                </div>
                                <div class="section-steps-alpha-item-number">
                                    <p>3</p>
                                </div>
                    ...
                    <div class="section-steps-alpha-item h-100">
                        ...
                        <div class="row align-items-center h-100">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="section-steps-alpha-item-content">
                                    <p>Fulfill the requirements for applying to the job so that we get to know you a little more better</p>
                                </div>
                                <div class="section-steps-alpha-item-number">
                                    <p>4</p>
                                </div>
